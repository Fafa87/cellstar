...
Details
-------
See our website __http://www.cellstar-algorithm.org/ where you can find not only matlab and plugin version of the algorithm but also a comprehensive set of example usages with ready to use pipelines for varies imagery.